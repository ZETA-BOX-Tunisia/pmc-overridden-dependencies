...
class PlutoCell {
  ...
  @override
  String toString() {
    return 'PlutoCell{_key: $_key, _value: $_value, _valueForSorting: $_valueForSorting, _needToApplyFormatOnInit: $_needToApplyFormatOnInit, _column: $_column, _row: $_row}';
  }
}
