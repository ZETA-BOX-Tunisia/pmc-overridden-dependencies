...
class PlutoGridConfiguration {
  ...
  bool operator ==(covariant Object other) {
    return identical(this, other) || other is PlutoGridConfiguration && runtimeType == other.runtimeType && enableMoveDownAfterSelecting == other.enableMoveDownAfterSelecting && enableMoveHorizontalInEditing == other.enableMoveHorizontalInEditing && enterKeyAction == other.enterKeyAction && tabKeyAction == other.tabKeyAction && shortcut == other.shortcut && style == other.style && scrollbar == other.scrollbar && columnFilter == other.columnFilter && columnSize == other.columnSize && localeText == other.localeText;
  }
...
class PlutoGridStyleConfig {
  const PlutoGridStyleConfig({
    ...
    this.rowGroupExpandedIcon = const Icon(Icons.keyboard_arrow_down),
    this.rowGroupCollapsedIcon = const Icon(IconData(
      0xe355,
  ...
  final Widget rowGroupExpandedIcon;

  /// Icon when RowGroup is collapsed.
  final Widget rowGroupCollapsedIcon;
  ...
  PlutoGridStyleConfig copyWith({
    ...
    Widget? rowGroupExpandedIcon,
    Widget? rowGroupCollapsedIcon,
...
class PlutoGridScrollbarConfig {
  ...
  @override
  bool operator ==(covariant Object other) {
    return identical(this, other) || other is PlutoGridScrollbarConfig && runtimeType == other.runtimeType && draggableScrollbar == other.draggableScrollbar && isAlwaysShown == other.isAlwaysShown && onlyDraggingThumb == other.onlyDraggingThumb && scrollbarThickness == other.scrollbarThickness && scrollbarThicknessWhileDragging == other.scrollbarThicknessWhileDragging && hoverWidth == other.hoverWidth && mainAxisMargin == other.mainAxisMargin && crossAxisMargin == other.crossAxisMargin && scrollBarColor == other.scrollBarColor && scrollBarTrackColor == other.scrollBarTrackColor && scrollbarRadius == other.scrollbarRadius && scrollbarRadiusWhileDragging == other.scrollbarRadiusWhileDragging && dragDevices == other.dragDevices;
  }
...
class PlutoGridColumnFilterConfig {
  ...
  @override
  bool operator ==(covariant Object other) {
    return identical(this, other) || other is PlutoGridColumnFilterConfig && runtimeType == other.runtimeType && listEquals(_userFilters, other._userFilters) && _userResolveDefaultColumnFilter == other._userResolveDefaultColumnFilter && _debounceMilliseconds == other._debounceMilliseconds;
  }
...
class PlutoGridColumnSizeConfig {
  ...
  @override
  bool operator ==(covariant Object other) {
    return identical(this, other) || other is PlutoGridColumnSizeConfig && runtimeType == other.runtimeType && autoSizeMode == other.autoSizeMode && resizeMode == other.resizeMode && restoreAutoSizeAfterHideColumn == other.restoreAutoSizeAfterHideColumn && restoreAutoSizeAfterFrozenColumn == other.restoreAutoSizeAfterFrozenColumn && restoreAutoSizeAfterMoveColumn == other.restoreAutoSizeAfterMoveColumn && restoreAutoSizeAfterInsertColumn == other.restoreAutoSizeAfterInsertColumn && restoreAutoSizeAfterRemoveColumn == other.restoreAutoSizeAfterRemoveColumn;
  }
