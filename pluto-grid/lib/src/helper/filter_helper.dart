...
class FilterHelper {
  ...
  static bool compareDoesNotContains({
    required String? base,
    required String? search,
    required PlutoColumn column,
  }) {
  ...
  static bool compareDoesNotEqual({
    required String? base,
    required String? search,
    required PlutoColumn column,
  }) {
...
class PlutoFilterTypeNotContains implements PlutoFilterType {
  static String name = 'Does Not Contains';
  @override
  String get title => PlutoFilterTypeNotContains.name;
  @override
  PlutoCompareFunction get compare => FilterHelper.compareDoesNotContains;
...
class PlutoFilterTypeDoesNotEquals implements PlutoFilterType {
  static String name = 'Does Not Equal';
  @override
  String get title => PlutoFilterTypeDoesNotEquals.name;
  @override
  PlutoCompareFunction get compare => FilterHelper.compareDoesNotEqual;
  const PlutoFilterTypeDoesNotEquals();
}
