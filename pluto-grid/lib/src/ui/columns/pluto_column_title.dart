  ...
  Widget build(BuildContext context) {
    ...
    final contextMenuIcon = Container(
      ...
      child: Align(
        ...
        child: IconButton(
          color:Colors.white, //style.iconColor,
    ...
    return OnHover(builder: (_isHovered) {
      final isHovered = _isHovered;
      return Container(
        color: widget.column.title.isEmpty?null:isHovered ? Color(0xff4D87B2) : null,
        child: Stack(
          children: [
            Positioned(
              left: 0,
                    ...
                    ? Listener(
                        ...
                        child: Container(
                          ...
                          child: Align(
                            alignment: Alignment.center,
                            child: IconButton(
                              color:isHovered?Colors.white:Colors.transparent, //style.iconColor,
                              icon: Icon(Icons.more_vert),
                              iconSize: style.iconSize,
                              mouseCursor: contextMenuCursor,
                              onPressed:()=> null,
      ...
      child: Draggable<PlutoColumn>(
        ...
        feedback: FractionalTranslation(
          ...
          child: PlutoShadowContainer(
            ...
            width: PlutoGridSettings.minColumnWidth - 20,
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: isHovered
                  ...
                  : noDragTarget
                      ? column.withOpacity
                          ? column.backgroundColor?.withOpacity(0.6)
...
class _ColumnTextWidgetState extends PlutoStateWithChange<_ColumnTextWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()=>widget.column.onTap?.call(),
      child: LayoutBuilder(
        builder: (ctx, constraints) {
          ...
          return overflow ?JustTheTooltip(
              preferredDirection: AxisDirection.up,
              tailLength: 8,
              offset: 10.0,
              tailBaseWidth: 14,
              margin: const EdgeInsets.only(bottom: 15),
              backgroundColor: const Color(0xFF023C6F),
              content: Padding(
                  ...
                  child: Text.rich(
                    ...
                    style: stateManager.configuration.style.columnTextStyle.copyWith(color: Colors.white),
                  )
              ),
              child: Text.rich(
                TextSpan(
                  ...
                  children: _children,
                    ...
                    style: stateManager.configuration.style.columnTextStyle.copyWith(
                        color: widget.column.backgroundColor == const Color(0xFF023C6F)
                            ? const Color(0xFFFFFFFF)
                            : widget.isHovered
                                ? const Color(0xFFFFFFFF)
                                : widget.column.titleColor ?? const Color(0xFF4F4F4F)),
                    overflow: TextOverflow.ellipsis,
                softWrap: false,
          maxLines: 1,
