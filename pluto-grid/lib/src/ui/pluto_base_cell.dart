  ...
  void _addGestureEvent(PlutoGridGestureType gestureType, Offset offset) {
    stateManager.eventManager!.addEvent(
      PlutoGridCellGestureEvent(
        gestureType: column.type is PlutoColumnTypeNumber ||
                column.type is PlutoColumnTypeText ||
                column.type is PlutoColumnTypeDate ||
                column.type is PlutoColumnTypeCurrency ||
                column.type is PlutoColumnTypeTime
            ? gestureType
            : column.type.select.items.isEmpty
                ? PlutoGridGestureType.none
                : gestureType,
        offset: offset,
        cell: cell,
        column: column,
...
class _CellContainerState extends PlutoStateWithChange<_CellContainer> {
    ...
    _decoration = update(
      ...
      _boxDecoration(
        ...
        isSelectedCell: stateManager.isSelectedCell(
            ...
            stateManager.currentSelectedCells
                .contains(PlutoGridSelectingCellPosition(field: widget.column.field, rowIdx: widget.rowIdx)),
  ...
  Color? _currentCellColor({
    ...
    return readOnly == true ? widget.cell.overridedColor ?? cellColorInReadOnlyState : cellColorInEditState;
  }
