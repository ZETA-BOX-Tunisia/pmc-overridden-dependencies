      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            ...List.generate(rangeEnd <= widget.pageTotal ? widget.threshold : widget.pageTotal % widget.threshold,
                (index) {
              return Flexible(
                  child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: ((currentPage - 1) % widget.threshold == index && index < 3)
                        ? widget.colorPrimary
                        : widget.colorSub,
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: (currentPage - 1) % widget.threshold == index ? widget.colorSub : Colors.black,
                    ),
                  ),
                ),
              ));
            }),
            if (widget.pageTotal > 4)
              if (rangeEnd <= widget.pageTotal)
                InkWell(
                  splashColor: Colors.transparent,
                  highlightColor: Colors.transparent,
                  child: Container(
